Feature: Enterprise Calculator System
    ...
    Rule: Addition operations must respect safety limits
        ...
        Scenario: Try to add values that result in overflow
            When I try to add 6000000 and 5000000
            Then the operation should fail
            And I should receive the message "Result exceeds maximum limit of 10 million"

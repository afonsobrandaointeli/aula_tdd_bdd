...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Try to add values that result in overflow")]
        [Xunit.TraitAttribute("FeatureTitle", "Enterprise Calculator System")]
        [Xunit.TraitAttribute("Description", "Try to add values that result in overflow")]
        public void TryToAddValuesThatResultInOverflow()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Try to add values that result in overflow", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 28
        this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 29
            testRunner.When("I try to add 6000000 and 5000000", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 30
            testRunner.Then("the operation should fail", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 31
            testRunner.And("I should receive the message \"Result exceeds maximum limit of 10 million\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
